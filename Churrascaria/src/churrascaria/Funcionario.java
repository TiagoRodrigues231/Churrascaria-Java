...
public class Funcionario extends Pessoa implements TemHistorico {
    ...
    public Funcionario(String nome, String cpf, float salario, String dataContratacao, String rua, String bairro, String cidade, String cep) {
        this.setCodigo(Banco.getFuncionarios().size());
        this.setNome(nome);
        this.setCpf(cpf);
    ...
    public ArrayList<Mesa> getHistorico(){
        ...
        Banco.getMesas().forEach(m -> {
            if (m.getFuncionario().getCodigo() == this.getCodigo())
